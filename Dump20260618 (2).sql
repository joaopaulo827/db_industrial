CREATE DATABASE  IF NOT EXISTS `db_industrial` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `db_industrial`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: db_industrial
-- ------------------------------------------------------
...
CREATE TABLE `ordem_servico` (
  ...
  `id_ferramenta` bigint(20) NOT NULL,
  `id_usuario_tecnico` bigint(20) NOT NULL,
  ...
  CONSTRAINT `ordem_servico_ibfk_1` FOREIGN KEY (`id_ferramenta`) REFERENCES `tb_ferramenta` (`id`),
  CONSTRAINT `ordem_servico_ibfk_2` FOREIGN KEY (`id_usuario_tecnico`) REFERENCES `tb_usuario` (`id`)
...
CREATE TABLE `tb_ferramenta` (
  ...
  `id_galpao` bigint(20) NOT NULL,
  `id_usuario_responsavel` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_galpao` (`id_galpao`),
  KEY `id_usuario_responsavel` (`id_usuario_responsavel`),
  CONSTRAINT `tb_ferramenta_ibfk_1` FOREIGN KEY (`id_galpao`) REFERENCES `tb_galpao` (`id`),
  CONSTRAINT `tb_ferramenta_ibfk_2` FOREIGN KEY (`id_usuario_responsavel`) REFERENCES `tb_usuario` (`id`)
...
--
-- Dumping events for database 'db_industrial'
--

--
-- Dumping routines for database 'db_industrial'
--
...
-- Dump completed on 2026-06-18 15:48:28
